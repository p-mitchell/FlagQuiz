...
public class MainActivityFragment extends Fragment {
   ...
   private static final int FLAGS_IN_QUIZ = 10; // TODO 4
   ...
   private int score;                    // TODO 5 score for guessed answers
   private int guessRows;                    // number of rows displaying guess Buttons
   private int firstGuess;               // TODO 6 answers guessed on the first attempt
   private int wrongGuess;               // TODO 6 if the user has any incorrect guesses
   private SecureRandom random;              // used to randomize the quiz
   private Handler handler;                  // used to delay loading next flag
   private Animation shakeAnimation;         // animation for incorrect guess

   private TextView quizScore;               // TODO 5 quiz score string
   ...
   public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      quizScore = (TextView) view.findViewById(R.id.quizScore);
   ...
   private OnClickListener guessButtonListener = new OnClickListener() {
      ...
      public void onClick(View v) {
         ...
         if (guess.equals(answer)) {    // if the guess is correct
            ...
            score = score + (guessRows * 2); // TODO 5
                                             // increase score by the number of options available
                                             // eg. 4 points is 4 options, 6 points if 6 options
            if (wrongGuess == 0) {           // TODO 6
               ++firstGuess;   // if the user has no wrong guesses, increment the first guess counter
            }
            wrongGuess = 0;                  // TODO 6 reset the wrong guess counter to 0
                     ...
                     public Dialog onCreateDialog(Bundle bundle) {
                        ...
                        builder.setMessage(
                           getString(R.string.results,
                              totalGuesses,
                              ((FLAGS_IN_QUIZ * 100) / (double) totalGuesses),
                                firstGuess));
                        ...
                        builder.setPositiveButton(R.string.reset_quiz,
                           new DialogInterface.OnClickListener() {
                              public void onClick(DialogInterface dialog,
                                 int id) {
                                 resetQuiz();
                                 updateScore(); // TODO 5 once the quiz is reset, reset the score
                              }
                           }
                        );
            ...
            score = score-1;           // TODO 5
                                        // decrease the score by 1 for each wrong answer
            ++wrongGuess; // TODO 6
